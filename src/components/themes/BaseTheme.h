...
class BaseTheme {
 public:
  ...
  virtual int getWifiStatusWidth(const GfxRenderer& renderer) const;
  virtual void drawWifiStatus(const GfxRenderer& renderer, int x, int y, bool black = true) const;
